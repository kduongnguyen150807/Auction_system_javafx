...
public class UserManagerController {
    ...
    private List<Node> userCardList = new ArrayList<>();
    ...
    private void updateDisplay() {
        ...
        for (int i = startIndex; i < endIndex; i++) {
            UserBox.getChildren().add(userCardList.get(i));
        }
    }
}