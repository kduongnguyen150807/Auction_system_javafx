...
public class ItemCardController {
    ...
    public void HandleItemClicked(){
        try{
            NodeContentLoader<ScrollPane> ThisItemInformation = new NodeContentLoader<>();
            ThisItemInformation.load("/ui/ItemInformation/ItemInformation.fxml");


            KhungController.switchNodeInContentArea( ThisItemInformation.getCurrentNode(),
                                            KhungController.GetCurrentNode());
        } catch(Exception e){
            System.out.println("iteminfo not found");
        }
    }
}