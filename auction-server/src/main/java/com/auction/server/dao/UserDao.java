...
public class UserDao implements UserRepository {
  ...
  public boolean signup(User user) {
    try (Connection conn = getConn()) {
      ...
      if (existsDuplicateUser(conn, normalizedUsername, normalizedEmail)) return false;
      ...
      LOGGER.log(Level.WARNING, "Signup failed", e);
      return false;
    }
  }
  ...
  public User getById(String id) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "getById failed for id=" + id, e);
    }
    return null;
  }
  ...
  public List<User> getAllUsers() {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "getAllUsers failed", e);
    }
    return users;
  }
  ...
  public List<User> searchUsers(String keyword) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "searchUsers failed", e);
    }
    return users;
  }
  ...
  public boolean updateBalance(int userId, double newBalance) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "updateBalance failed", e);
      return false;
    }
  }

  /**
   * Atomic deduction: SET balance = balance - ? WHERE id = ? AND balance >= ?
   * Returns true if deduction succeeded (sufficient funds).
   */
  public boolean atomicDeductBalance(int userId, double amount) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "atomicDeductBalance failed", e);
      return false;
    }
  }

  /**
   * Atomic credit: SET balance = balance + ? WHERE id = ?
   */
  public boolean atomicCreditBalance(int userId, double amount) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "atomicCreditBalance failed", e);
      return false;
    }
  }
  ...
  public boolean setUserLocked(String username, boolean lockStatus) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "setUserLocked failed", e);
      return false;
    }
  }
  ...
  public boolean setUserRole(String username, String role) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "setUserRole failed", e);
      return false;
    }
  }
  ...
  public boolean addBidderMetrics(int userId, double amount) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "addBidderMetrics failed", e);
      return false;
    }
  }
  ...
  public boolean addSellerMetrics(int userId, double amount) {
    ...
    try (Connection conn = getConn(); PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      LOGGER.log(Level.WARNING, "addSellerMetrics failed", e);
      return false;
    }
  }
  ...
  private User mapResultSetToUser(ResultSet rs) throws SQLException {
    ...
    User user;
    if (role.equalsIgnoreCase("ADMIN")) user = new Admin();
    else if (role.equalsIgnoreCase("SELLER")) user = new Seller();
    else user = new Bidder();
    ...
    try { user.setAvgRating(rs.getDouble("avgrating")); } catch (Exception e) { /* column may not exist */ }
    try { user.setTotalRatings(rs.getInt("totalratings")); } catch (Exception e) { /* column may not exist */ }
    return user;
  }
